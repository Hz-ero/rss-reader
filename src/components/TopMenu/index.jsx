...
import { Icon, Dropdown, Label, Menu, Modal, Button } from 'semantic-ui-react'
...
>
    ...
    <Modal.Actions>
        <Button 
            ...
            negative labelPosition='right' icon='close' content='No' />
        <Button 
            onClick={()=>this.clickConfirmSetReaded()}
            positive labelPosition='right' icon='checkmark' content='Yes' />
    </Modal.Actions>
</Modal>
