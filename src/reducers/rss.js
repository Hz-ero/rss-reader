import { FETCH_RSS, PANEL_POP, SET_ALL_READED } from '../actions/actionTypes.js'
...
const handle_fetchRssDone = (state, action) => {
...
const toggleRssReaded = (state, action) => {
    ...
    const toggleIndex = newState.findIndex(item => {
        return item.guid === action.payload.articleItem.guid
    })
